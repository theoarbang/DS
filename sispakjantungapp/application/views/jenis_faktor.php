    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="box-content">
                <form role="form" action="<?php echo site_url('admin/addjresikogejala');?>" method="POST">
                    <input type="hidden" placeholder="Enter email">
                    <div class="form-group">
                        <label>Nama Jenis Faktor Gejala</label>
                        <input type="text" class="form-control" placeholder="Nama Jenis Faktor Gejala" name="nama_jns_faktor">
                    </div>
