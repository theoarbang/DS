    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="box-content">
                <form role="form" action="<?php echo site_url('admin/addparamedis'); ?>" method = "POST">
                    <input type="hidden" placeholder="Enter email" name="id" value="">
                    <div class="form-group">
                        <label>Nama Paramedis</label>
                        <input type="text" class="form-control" placeholder="Nama Paramedis" name="nama_paramedis" value="" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="No. Telp/HP" name="telp" value="">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
