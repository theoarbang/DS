...
<div class="row">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-plus"></i> Ubah Diagnosa</h2>
            ...
            <div class="box-content row">
                <div class="box-content">
                <form role="form" action="<?php echo site_url('admin/updatediagnosa');?>" method="POST">
                    <input type="hidden" placeholder="Enter email" value="<?php echo $dataedit[0]->id_diagnosa ?>" name="id">
                    <div class="form-group">
                        <label>Nama Diagnosa</label>
                        <input type="text" class="form-control" placeholder="Nama Diagnosa" name='nama_diagnosa' value="<?php echo $dataedit[0]->nama_diagnosa; ?>">
                    </div>
                    <div class="form-group">
                        <label>Inisial Diagnosa</label>
                        <input type="text" class="form-control" placeholder="Inisial Diagnosa" name='inisial' value="<?php echo $dataedit[0]->inisial; ?>">
                    </div>
