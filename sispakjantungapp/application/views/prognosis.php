...
<div class="row">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-plus"></i> Tambah Prognosis</h2>
            ...
            <div class="box-content row">
                <div class="box-content">
                <form role="form" action="<?php echo site_url('admin/addprognosis'); ?>" method="POST">
                    <input type="hidden" placeholder="Enter email" name="" value=" ">
                    <div class="form-group">
                        <label>Nama Prognosis</label>
                        <input type="text" class="form-control" placeholder="Nama Prognosis" name="nama_prognosis" value="">
                    </div>                  
