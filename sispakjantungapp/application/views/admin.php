    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="box-content">
                <form role="form" action="<?php echo site_url('admin/addpakar'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="admin" id="inlineRadio1" value="1"> Administrator
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="admin" id="inlineRadio2" value="2"> Pakar
                        </label>
                    </div>
