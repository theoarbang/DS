                ...
                <div class="box-content col-md-10">
                    ...
                    <table class="table table-striped table-bordered responsive" id="myTable">
                        <tr>
                            ...
                            <td><?php echo $dataedit[0]->nama_pasien ?></td>
                        </tr>
                        <tr>
                            <td><b>Tgl Lahir</b></td>
                            <td><?php echo $dataedit[0]->tgl_lahir_pasien ?></td>
                        </tr>
                        <tr>
                            <td><b>Telp</b></td>
                            <td><?php echo $dataedit[0]->alamat_pasien ?></td>
                        </tr>
                        <tr>
                            <td><b>Alamat</b></td>
                            <td><?php echo $dataedit[0]->telp_pasien ?></td>
                        </tr>
                        <tr>
                            <td><b>Jenis Kelamin</b></td>
                            <td><?php echo $dataedit[0]->jk_pasien ?></td>
                        </tr>
                        <tr>
                            <td><b>Status Pasien</b></td>
                            <td><?php echo $dataedit[0]->status ?></td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>:</td>
                            <td><h4><?php echo $diagnosa; ?></h4></td>
                        </tr>
                        <tr>
                            <td><h4>Densitas</h4></td>
                            <td>:</td>
                            <td><h4><?php echo $densitas ?> %</h4></td>
                        </tr>
                    </table>
                    <h3>Saran Tindakan</h3> <hr>
                    <h4><?php echo $tindakan[0]->nama_tindakan ?></h4>
                    <p><?php echo $tindakan[0]->detail ?></p>
                    <table>
                    </table>
